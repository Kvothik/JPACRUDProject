		...
		<body style="background-color: lightgray">
			<div class="container">
				...
				<div class="row">
					<div class="col-4"></div>
					<div class="col-4">
						<h1 style="color: red">Update this Player</h1>
						<c:choose>
						...
						<form:form action="playerUpdate.do" method="POST" items="${player}">
							<div class="form-group">
								<input type="hidden" name="id" value="${player.id}" /> <label
									...
									class="form-control" value="${player.firstName}"> <br> <label
									...
									value="${player.homeruns}"> <br> <label
									for="rbi">RBI</label> <input type="text"
									name="rbi" class="form-control"
									value="${player.rbi}"> 
