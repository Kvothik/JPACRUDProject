...
<title>Player Lookup by ID</title>
</head>
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-3"></div>
			<div class="col-6">
				<form:form action="playerByID.do" method="GET">
					<div class="form-group">
						<label for="id">Player ID</label> <input type="text" name="id"
							class="form-control" placeholder="Enter Player ID">
					</div>
