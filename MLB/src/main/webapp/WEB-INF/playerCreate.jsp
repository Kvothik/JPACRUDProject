				...
				<form:form action="playerCreate.do" method="POST">
					<div class="form-group">
						...
						<label for="lastName">Last Name</label> <input type="text"
							...
							<label for="homeruns">Home Runs</label> <input type="text" name="homeruns" class="form-control"
							placeholder="Home Runs" required="required"> <br>
						
						<label for="rbi">RBI (runs batted in)</label> <input type="text" name="rbi" class="form-control"
							placeholder="RBI" required="required"> <br>
						...
						<input type="text" name="team" class="form-control"
							placeholder="Team" required="required"> <br>
							
							 <label
							for="age">Age</label> <input type="text"
							name="age" class="form-control"
							placeholder="Age" required="required"> <br>
						
						<label for="uniformNumber">Uniform Number</label> <input type="text" name="uniformNumber" class="form-control"
							placeholder="Uniform Number" required="required"> <br><br>
